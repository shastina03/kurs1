...
<head>
    ...
    <title>Технология выгоды PRO</title>
</head>
<body>
    ...
    <div class="container mt-5">
      <div class="offer">
                <h1>Технология выгоды PRO</h1>
                <h1>Что может быть включено в тариф?</h1>
                <p>Интернет последнего поколения. Скорость - 200 Мбит/с. Быстрое и надежное решение для базовой защиты компьютера. Kaspersky Internet Security (2 устройства) в тарифе. Расширенный объем облачного хранилища. </p>


                <button type="button" class="btn btn-primary buy" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-price="1470 рублей/месяц" data-product="Технологии выгоды">
                  Купить
                </button>
    <h1></h1>
    <img src="img/tarif6_pic.png" alt="WAYUP" align="right" class="image1">
            </div>
    </div>
