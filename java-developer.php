...
<body>
    ...
    <div class="container mt-5">
      <div class="offer">
                <h1>2 в 1 Продвинутый</h1>
                <h1>Что может быть включено в тариф?</h1>
                <p>Интернет последнего поколения. Скорость - 100 Мбит/с. Технология - FTTb. Mаршрутизатор FTTx с опцией WI-FI свыше 100 мб (Medium).Скорость интернета: до 1 Гбит/с Количество подключаемых устройств: 16, радиус действия внутри помещения: 100 м</p>


                <button type="button" class="btn btn-primary buy" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-price="789 рублей/месяц" data-product="2 в 1 Продвинутый">
                  Купить
                </button>
    <h1></h1>
    <img src="img/tarif3_pic.png" alt="WAYUP" align="right" class="image1">
            </div>
    </div>
